...
style.textContent = `
.gameframe-session-badge .gameframe-alerts{position:absolute;top:50%;right:calc(100% + 8px);transform:translateY(-50%)}
...
.gameframe-alerts-panel{position:absolute;top:calc(100% + 12px);right:0;width:min(360px,calc(100vw - 24px));overflow:hidden;border:1px solid rgba(139,156,255,.32);border-radius:16px;background:rgba(10,14,28,.98);box-shadow:0 24px 60px rgba(0,0,0,.48);color:#f5f7ff;text-align:left}
