    ...
    <form method="dialog" class="cascade-admin-panel">
      ...
      <section class="cascade-admin-section">
        ...
        <div class="cascade-admin-jumps" aria-label="Quick level jumps">
          ...
          <button type="button" data-level="300">300</button>
          <button type="button" data-level="301">301</button>
          <button type="button" data-level="330">330</button>
          <button type="button" data-level="360">360</button>
          ...
          <button type="button" data-level="651">651</button>
          <button type="button" data-level="701">701</button>
          <button type="button" data-level="751">751</button>
          <button type="button" data-level="801">801</button>
          <button type="button" data-level="901">901</button>
          <button type="button" data-level="951">951</button>
          <button type="button" data-level="1000">1000</button>
        </div>
      </section>
