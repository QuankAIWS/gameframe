...
- Cognitive-mechanic density distinguishes **foundation arcs** from **steady-state recurrence**: dedicated Recall Lock (701–750), Memory Bloom (751–800), and Color Ward (951–1,000) teaching arcs may be dense; after a family is established, normal mixed chapters return toward roughly 4–6 explicit cognitive-accent levels per 30-level chapter unless player evidence supports a different cadence.
- Do not casually rewrite accepted historical level definitions while adding later mechanics. Older-range changes must be deliberate and visible in the change-aware Cascade CI plan.
