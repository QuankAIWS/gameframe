...
replacements = [
    ...
    ('"voidshard-reaver-v1": Object.freeze({ kind: "voidshard", asset: "/assets/monster-master/creatures/voidshard-reaver-v1-128.webp", label: "Voidshard Reaver", glyph: "V", prototypeLabel: "Emberling", anchorY: 0.9, battlefieldScale: 1.42 }),', '"voidshard-reaver-v1": Object.freeze({ kind: "voidshard", asset: "/assets/monster-master/creatures/voidshard-reaver-v1-128.webp", label: "Voidshard Reaver", glyph: "V", prototypeLabel: "Emberling", authoredFacing: "left", summary: "Mobile melee striker.", anchorY: 0.9, battlefieldScale: 1.42 }),'),
    ...
    ('"mossmaw-colossus-v1": Object.freeze({ kind: "mossmaw", asset: "/assets/monster-master/creatures/mossmaw-colossus-v1-128.webp", label: "Mossmaw Colossus", glyph: "M", prototypeLabel: "Stone Bulwark", anchorY: 0.9, battlefieldScale: 1.5 }),', '"mossmaw-colossus-v1": Object.freeze({ kind: "mossmaw", asset: "/assets/monster-master/creatures/mossmaw-colossus-v1-128.webp", label: "Mossmaw Colossus", glyph: "M", prototypeLabel: "Stone Bulwark", authoredFacing: "left", summary: "Slow durable anchor.", anchorY: 0.9, battlefieldScale: 1.5 }),'),
]
