...
test("public profiles offer the three shared 1v1 board games", async ({ page }) => {
  ...
  await expect(panel.getByRole("link", { name: "Tic-Tac-Toe" })).toHaveAttribute("href", "/?game=tic-tac-toe&menu=1");
  await expect(panel.getByRole("link", { name: "Clockwork Checkers" })).toHaveAttribute("href", "/?game=american-checkers&menu=1");
