...
test("Cascade hydrates the better server progression and preserves better local stars", async ({ page }) => {
...
test("a stale device cannot submit progression lower than the canonical server state", async ({ page }) => {
