...
test("Monster Master loads deterministic generated creature and terrain art before gameplay", async () => {
  ...
  assert.ok(launcher.indexOf("monster-master-terrain.js") < launcher.indexOf("await import(entry)"));
